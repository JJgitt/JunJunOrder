...
完整的业务规则、技术实现和维护指南见 [系统知识库](docs/系统知识库.md)。当前库表、字段、索引和外键见 [数据库设计](docs/数据库设计.md)。采购员与管理员的录单分步操作见 [上传订单教程](docs/%E4%B8%8A%E4%BC%A0%E8%AE%A2%E5%8D%95%E6%95%99%E7%A8%8B.html)。
