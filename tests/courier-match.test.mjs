...
test("all courier numbers link directly to kuaidi100 without calling an API", () => {
  assert.equal(courierTrackingUrl("sf 1392-0415 8866"),
    "https://www.kuaidi100.com/chaxun?nu=SF139204158866");
  assert.equal(courierTrackingUrl("JD014892367120"),
    "https://www.kuaidi100.com/chaxun?nu=JD014892367120");
  assert.equal(courierTrackingUrl("DPK123456789"),
    "https://www.kuaidi100.com/chaxun?nu=DPK123456789");
  assert.equal(courierTrackingUrl(""), "");
});
